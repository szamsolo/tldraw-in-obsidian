...
export function parseEmbedValues(el: HTMLElement, {
    showBgDefault,
    imageBounds = {
        pos: { x: 0, y: 0 },
        size: {
...
export function updateEmbedBounds(widget: InternalEmbedWidget, pageBounds: EmbedUpdate['pageBounds'], editor: Editor) {
